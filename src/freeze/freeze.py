...
class FSet(AbstractSet[TYPE]):
    ...
    def __or__(self, other: AbstractSet[TYPE]) -> FSet[TYPE]:
        return FSet(self._frozenset | other)

    def __ror__(self, other: AbstractSet[TYPE]) -> FSet[TYPE]:
        return FSet(self._frozenset | other)

    def __and__(self, other: AbstractSet[TYPE]) -> FSet[TYPE]:
        return FSet(self._frozenset & other)

    def __rand__(self, other: AbstractSet[TYPE]) -> FSet[TYPE]:
        return FSet(self._frozenset & other)
